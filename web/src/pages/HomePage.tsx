    ...
    <div className="home-page">
      <div className="home-page__miles-summary">
        <h1 className="home-page__miles-summary-title">
          ...
          <span className="home-page__miles-sum">
            {parseNumber(milesSum)}
          </span>{" "}
          miles.
        </h1>
      ...
      <div className="home-page__conversion-table">
        <ConversionTable
          tableData={tableData}
          onCardSelectChange={handleCardSelectChange}
